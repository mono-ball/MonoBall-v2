...
/// <summary>
/// Trigger Script: route110 event script rival trigger2
/// Original: route110_event_script_rival_trigger2
/// </summary>
public class Route110EventScriptRivalTrigger2 : ScriptBase
{

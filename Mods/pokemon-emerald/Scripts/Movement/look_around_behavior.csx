...
public class LookAroundBehavior : ScriptBase
{
    ...
    {
        // Subscribe to timer elapsed to know when to change direction
        On<TimerElapsedEvent>(OnTimerElapsed);
        
        Context.Logger.Debug("Look around behavior: Event handlers registered");
    }
    ...
    private void OnTimerElapsed(TimerElapsedEvent evt)
    {
        ...
        // Update timer with new random interval for next look
    ...
    public override void OnUnload()
    {
        ...
        Context.Logger.Debug("Look around behavior deactivated");
        base.OnUnload();
    }
}

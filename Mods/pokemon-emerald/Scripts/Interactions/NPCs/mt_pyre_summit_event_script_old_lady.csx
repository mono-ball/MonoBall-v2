...
/// <summary>
/// NPC Interaction: mt pyre summit event script old lady
/// Original: mt_pyre_summit_event_script_old_lady
/// </summary>
public class MtPyreSummitEventScriptOldLady : ScriptBase
{

...
/// <summary>
/// NPC Interaction: petalburg city mart event script boy
/// Original: petalburg_city_mart_event_script_boy
/// </summary>
public class PetalburgCityMartEventScriptBoy : ScriptBase
{

...
/// <summary>
/// NPC Interaction: fortree city mart event script woman
/// Original: fortree_city_mart_event_script_woman
/// </summary>
public class FortreeCityMartEventScriptWoman : ScriptBase
{

...
/// <summary>
/// NPC Interaction: gabby and ty event script ty battle2
/// Original: gabby_and_ty_event_script_ty_battle2
/// </summary>
public class GabbyAndTyEventScriptTyBattle2 : ScriptBase
{

...
/// <summary>
/// NPC Interaction: aqua hideout b1f event script grunt3
/// Original: aqua_hideout_b1f_event_script_grunt3
/// </summary>
public class AquaHideoutB1fEventScriptGrunt3 : ScriptBase
{

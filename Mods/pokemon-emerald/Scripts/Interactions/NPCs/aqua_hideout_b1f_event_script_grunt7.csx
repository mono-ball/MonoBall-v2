...
/// <summary>
/// NPC Interaction: aqua hideout b1f event script grunt7
/// Original: aqua_hideout_b1f_event_script_grunt7
/// </summary>
public class AquaHideoutB1fEventScriptGrunt7 : ScriptBase
{

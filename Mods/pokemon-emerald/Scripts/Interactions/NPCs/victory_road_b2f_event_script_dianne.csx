...
/// <summary>
/// NPC Interaction: victory road b2f event script dianne
/// Original: victory_road_b2f_event_script_dianne
/// </summary>
public class VictoryRoadB2fEventScriptDianne : ScriptBase
{

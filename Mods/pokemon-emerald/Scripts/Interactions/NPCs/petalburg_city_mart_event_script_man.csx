...
/// <summary>
/// NPC Interaction: petalburg city mart event script man
/// Original: petalburg_city_mart_event_script_man
/// </summary>
public class PetalburgCityMartEventScriptMan : ScriptBase
{

...
/// <summary>
/// NPC Interaction: sootopolis city event script woman2
/// Original: sootopolis_city_event_script_woman2
/// </summary>
public class SootopolisCityEventScriptWoman2 : ScriptBase
{

...
/// <summary>
/// NPC Interaction: dewford town gym event script brawly
/// Original: dewford_town_gym_event_script_brawly
/// </summary>
public class DewfordTownGymEventScriptBrawly : ScriptBase
{

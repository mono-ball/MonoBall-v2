...
/// <summary>
/// NPC Interaction: dewford town hall event script woman
/// Original: dewford_town_hall_event_script_woman
/// </summary>
public class DewfordTownHallEventScriptWoman : ScriptBase
{

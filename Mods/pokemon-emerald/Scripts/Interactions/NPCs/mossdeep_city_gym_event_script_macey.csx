...
/// <summary>
/// NPC Interaction: mossdeep city gym event script macey
/// Original: mossdeep_city_gym_event_script_macey
/// </summary>
public class MossdeepCityGymEventScriptMacey : ScriptBase
{

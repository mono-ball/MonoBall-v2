...
/// <summary>
/// NPC Interaction: gabby and ty event script ty battle4
/// Original: gabby_and_ty_event_script_ty_battle4
/// </summary>
public class GabbyAndTyEventScriptTyBattle4 : ScriptBase
{

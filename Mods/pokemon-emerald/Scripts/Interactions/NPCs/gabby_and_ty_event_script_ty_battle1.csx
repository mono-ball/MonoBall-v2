...
/// <summary>
/// NPC Interaction: gabby and ty event script ty battle1
/// Original: gabby_and_ty_event_script_ty_battle1
/// </summary>
public class GabbyAndTyEventScriptTyBattle1 : ScriptBase
{

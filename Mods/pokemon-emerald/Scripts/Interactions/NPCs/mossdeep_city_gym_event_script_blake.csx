...
/// <summary>
/// NPC Interaction: mossdeep city gym event script blake
/// Original: mossdeep_city_gym_event_script_blake
/// </summary>
public class MossdeepCityGymEventScriptBlake : ScriptBase
{

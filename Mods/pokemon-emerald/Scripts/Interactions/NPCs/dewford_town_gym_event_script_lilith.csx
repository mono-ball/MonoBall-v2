...
/// <summary>
/// NPC Interaction: dewford town gym event script lilith
/// Original: dewford_town_gym_event_script_lilith
/// </summary>
public class DewfordTownGymEventScriptLilith : ScriptBase
{

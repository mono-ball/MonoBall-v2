...
/// <summary>
/// NPC Interaction: ss tidal corridor event script peeko
/// Original: ss_tidal_corridor_event_script_peeko
/// </summary>
public class SsTidalCorridorEventScriptPeeko : ScriptBase
{

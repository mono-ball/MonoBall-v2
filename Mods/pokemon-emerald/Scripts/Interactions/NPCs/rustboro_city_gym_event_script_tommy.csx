...
/// <summary>
/// NPC Interaction: rustboro city gym event script tommy
/// Original: rustboro_city_gym_event_script_tommy
/// </summary>
public class RustboroCityGymEventScriptTommy : ScriptBase
{

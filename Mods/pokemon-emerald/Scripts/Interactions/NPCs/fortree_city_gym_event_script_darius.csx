...
/// <summary>
/// NPC Interaction: fortree city gym event script darius
/// Original: fortree_city_gym_event_script_darius
/// </summary>
public class FortreeCityGymEventScriptDarius : ScriptBase
{

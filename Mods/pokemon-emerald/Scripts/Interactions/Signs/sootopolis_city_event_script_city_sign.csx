...
/// <summary>
/// Sign Script: sootopolis city event script city sign
/// Original: sootopolis_city_event_script_city_sign
/// </summary>
public class SootopolisCityEventScriptCitySign : ScriptBase
{

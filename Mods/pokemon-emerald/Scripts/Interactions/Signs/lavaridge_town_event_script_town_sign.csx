...
/// <summary>
/// Sign Script: lavaridge town event script town sign
/// Original: lavaridge_town_event_script_town_sign
/// </summary>
public class LavaridgeTownEventScriptTownSign : ScriptBase
{

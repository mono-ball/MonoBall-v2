...
/// <summary>
/// Sign Script: littleroot town event script town sign
/// Original: littleroot_town_event_script_town_sign
/// </summary>
public class LittlerootTownEventScriptTownSign : ScriptBase
{

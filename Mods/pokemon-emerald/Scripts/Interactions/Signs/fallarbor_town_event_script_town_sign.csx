...
/// <summary>
/// Sign Script: fallarbor town event script town sign
/// Original: fallarbor_town_event_script_town_sign
/// </summary>
public class FallarborTownEventScriptTownSign : ScriptBase
{

...
/// <summary>
/// Sign Script: pacifidlog town event script town sign
/// Original: pacifidlog_town_event_script_town_sign
/// </summary>
public class PacifidlogTownEventScriptTownSign : ScriptBase
{

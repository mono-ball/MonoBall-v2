...
/// <summary>
/// Sign Script: petalburg city event script city sign
/// Original: petalburg_city_event_script_city_sign
/// </summary>
public class PetalburgCityEventScriptCitySign : ScriptBase
{

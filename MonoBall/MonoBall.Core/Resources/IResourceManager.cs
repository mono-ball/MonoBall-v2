...
public interface IResourceManager
{
    ...
    ///     Thrown when definition not found, source file missing, or shader bytecode
    ///     invalid.
    /// </exception>
    ...
    IReadOnlyList<TileAnimationFrame>? GetCachedTileAnimation(string tilesetId, int localTileId);
    ...
    IReadOnlyList<SpriteAnimationFrame> GetAnimationFrames(string spriteId, string animationName);

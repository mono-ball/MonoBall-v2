    ...
    public static class ScriptParameterConverter
    {
        ...
        )
        {
            ...
            try
            {
                ...
                if (jsonValue is System.Text.Json.JsonElement jsonElement)
                {
        ...
        )
        {
            return paramType switch
            {
                "int" => jsonElement.ValueKind switch
                {
                    ...
                    System.Text.Json.JsonValueKind.String => int.Parse(
                ...
                "float" => jsonElement.ValueKind switch
                {
                    ...
                    System.Text.Json.JsonValueKind.String => float.Parse(
                        jsonElement.GetString()
                ...
                "bool" => jsonElement.ValueKind switch
                {
                    ...
                    System.Text.Json.JsonValueKind.String => bool.Parse(
                        jsonElement.GetString()
                ...
                {
                    System.Text.Json.JsonValueKind.String => Vector2Parser.Parse(
                        jsonElement.GetString()

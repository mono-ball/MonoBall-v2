...
namespace MonoBall.Core.UI.Windows
{
    ...
    public class WindowRenderer
    {
        ...
        /// Optional renderers (null) are skipped silently - this is by design to allow windows without borders, backgrounds, or content.
        /// If animation is provided, position offset and scale are applied. Opacity transformations are calculated but not applied

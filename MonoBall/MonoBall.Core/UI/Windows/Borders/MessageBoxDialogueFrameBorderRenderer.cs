        ...
        )
        {
            ...
            Rectangle GetTileSourceRect(int tileIndex)
            {
                ...
                else
                {
                    ...
                    int tileWidth = _tilesheetDef.TileWidth;
                    int tileHeight = _tilesheetDef.TileHeight;
                    int columns =
            ...
            int topY = interiorY - _scaledTileSize;
            ...
            for (int i = 0; i < interiorWidth - _scaledTileSize; i += _scaledTileSize)
            {
            ...
            // Left edge tile 7
            for (int i = 0; i < middleHeight; i += _scaledTileSize)
            {
            ...
            for (int i = 0; i < interiorWidth + _scaledTileSize; i += _scaledTileSize)
            {
                for (int j = 0; j < middleHeight; j += _scaledTileSize)
                {

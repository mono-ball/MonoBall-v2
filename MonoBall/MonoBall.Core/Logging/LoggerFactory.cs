            ...
            lock (_lockObject)
            {
                ...
                var loggerConfiguration = new LoggerConfiguration()
                    ...
                    .WriteTo.Async(
                        ...
                        bufferSize: 100000, // Very large buffer (100k events) for high-volume logging
                        blockWhenFull: false // Drop logs if buffer is full rather than blocking game thread
                    );

        ...
        IDisposable
{
    ...
    )
    {
        ...
        else if (animation.PingPong)
        {
            ...
            var cycleDuration = animation.Duration * 2.0f;
            animation.ElapsedTime = animation.ElapsedTime % cycleDuration;
            var cycleTime = animation.ElapsedTime;
        ...
        var oldValue = parameters.TryGetValue(animation.ParameterName, out var existingValue)
            ? existingValue
            : null;

...
public class PlayerSystem : BaseSystem<World, float>, IPrioritizedSystem
{
    ...
    /// </summary>
    /// <param name="spriteSheetId">
    ///     Optional sprite sheet ID. Defaults to
    ///     <see cref="GameConstants.DefaultPlayerSpriteSheetId" /> if not provided.
    /// </param>
    /// <param name="initialAnimation">
    ///     Optional initial animation name. Defaults to
    ///     <see cref="GameConstants.DefaultPlayerInitialAnimation" /> if not provided.
    /// </param>
    /// <param name="cameraEntity">
    ///     Optional camera entity. If provided, uses this camera's position. Otherwise queries for
    ///     active camera.
    /// </param>
    /// <remarks>
    ...
    )
    {
        ...
        var spriteSheet = spriteSheetId ?? _constants.GetString("PlayerSpriteSheetId");
        var animation = initialAnimation ?? _constants.GetString("PlayerInitialAnimation");
        ...
        var tileWidth = cameraComponent.TileWidth;
        var tileHeight = cameraComponent.TileHeight;

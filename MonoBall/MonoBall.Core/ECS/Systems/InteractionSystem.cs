    ...
    public class InteractionSystem : BaseSystem<World, float>, IPrioritizedSystem, IDisposable
    {
        ...
        public override void Update(in float deltaTime)
        {
            ...
            World.Query(
                ...
                (Entity entity, ref InteractionComponent interaction, ref PositionComponent pos) =>
                {
                    ...
                    Direction directionToEntity = DirectionHelper.GetDirectionTo(
                        playerTileX,
                        playerTileY,
                        interactionTileX,
                        interactionTileY
                    ...
                    {
                        Direction requiredDirection = interaction.RequiredFacing.Value;
        ...
        )
        {
            ...
            if (World.Has<NpcComponent>(interactionEntity))
            {
                ...
                {
                    var behaviorDef = _registry.GetById<BehaviorDefinition>(

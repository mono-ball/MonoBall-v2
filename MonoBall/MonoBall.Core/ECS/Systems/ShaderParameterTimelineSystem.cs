...
public class ShaderParameterTimelineSystem : BaseSystem<World, float>
{
    ...
    )
    {
        ...
        var t = CalculateInterpolationFactor(
        ...
        var interpolatedValue = InterpolateKeyframes(currentKeyframe.Value, nextKeyframe.Value, t);

        if (interpolatedValue != null)
        {
            var oldValue = parameters.TryGetValue(timeline.ParameterName, out var old) ? old : null;

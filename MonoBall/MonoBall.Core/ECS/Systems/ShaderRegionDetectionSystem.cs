        ...
        public override void Update(in float deltaTime)
        {
            ...
            World.Query(
                ...
                (Entity entity, ref ShaderRegionComponent region) =>
                {
                    ...
                    bool wasInside = region.IsPlayerInside;
                    bool isNowInside = region.Contains(playerTileX, playerTileY);
            ...
            Entity? newActiveRegion =
                regionsPlayerIsIn.Count > 0 ? regionsPlayerIsIn[0].Entity : null;
            int newPriority =

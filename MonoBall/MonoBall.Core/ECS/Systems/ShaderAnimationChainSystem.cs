...
public class ShaderAnimationChainSystem : BaseSystem<World, float>, IPrioritizedSystem, IDisposable
{
    ...
    public override void Update(in float deltaTime)
    {
        ...
        World.Query(
            ...
            (Entity entity, ref ShaderComponent shader, ref ShaderAnimationChainComponent chain) =>
            {
                if (
                    !shader.IsEnabled
                    || !chain.IsEnabled
    ...
    )
    {
        ...
        var phaseStartTime = currentPhase.Delay;
        var phaseEndTime = phaseStartTime + currentPhase.Duration;
        ...
        // Update animations
        var phaseProgress = chain.PhaseElapsedTime - phaseStartTime;
        ...
        if (chain.PhaseElapsedTime >= phaseEndTime)
        {
            ...
            var hasMorePhases = chain.CurrentPhaseIndex < totalPhases - 1;

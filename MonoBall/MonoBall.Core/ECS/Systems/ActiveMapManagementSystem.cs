...
/// </summary>
public class ActiveMapManagementSystem : BaseSystem<World, float>, IPrioritizedSystem, IDisposable
{
    ...
    {
        var activeMapIds = _activeMapFilterService.GetActiveMapIds();
        ...
        World.Query(
            ...
            (Entity entity, ref NpcComponent npc) =>
            {
                ...
                var shouldBeActive = activeMapIds.Contains(npc.MapId);
                var isActive = World.Has<ActiveMapEntity>(entity);

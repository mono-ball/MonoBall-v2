...
namespace MonoBall.Core.ECS.Systems
{
    ...
    public class MapConnectionSystem : BaseSystem<World, float>
    {
        ...
        public Microsoft.Xna.Framework.Vector2 CalculateConnectedMapPosition(
            string sourceMapId,
            int sourceMapWidth,
            int sourceMapHeight,
            int tileWidth,
        ...
        {
            var position = Microsoft.Xna.Framework.Vector2.Zero;

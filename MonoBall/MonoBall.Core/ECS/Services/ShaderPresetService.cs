        ...
        switch (element.ValueKind)
        {
            ...
            case JsonValueKind.Array:
                ...
                if (array.Length == 4)
                {
                    ...
                    var r = array[0].GetSingle();
                    var g = array[1].GetSingle();
                    var b = array[2].GetSingle();
                    var a = array[3].GetSingle();
            ...
            case JsonValueKind.Object:
                ...
                {
                    var r = rProp.GetSingle();
                    var g = gProp.GetSingle();
                    var b = bProp.GetSingle();
                    var a = element.TryGetProperty("a", out var aProp) ? aProp.GetSingle() : 1.0f;
                    return new Vector4(r, g, b, a);
                }

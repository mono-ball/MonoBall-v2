...
namespace MonoBall.Core.ECS.Services
{
    ...
    public class VariableSpriteResolver : IVariableSpriteResolver, IDisposable
    {
        ...
        private readonly Dictionary<string, string> _resolutionCache =
        ...
        public string? ResolveVariableSprite(string variableSpriteId, Entity? entity = null)
        {
            ...
            string extractedSpriteId = ExtractVariableSpriteId(variableSpriteId);
            ...
            string? resolvedSpriteId = _flagVariableService.GetVariable<string>(extractedSpriteId);

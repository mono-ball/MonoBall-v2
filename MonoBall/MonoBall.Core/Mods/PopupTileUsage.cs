...
namespace MonoBall.Core.Mods
{
    ...
    public class PopupTileUsage
    {
        ...
        public List<int> TopEdge { get; set; } = new List<int>();
        ...
        public List<int> BottomEdge { get; set; } = new List<int>();
    }
}

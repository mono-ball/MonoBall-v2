...
public class TextEffectDefinition
{
    ...
    public TextEffectType EffectTypes
    {
        get
        {
            ...
            foreach (var name in EffectTypeNames)
                if (Enum.TryParse<TextEffectType>(name, true, out var parsed))
                    result |= parsed;
    ...
    public ColorEffectMode ColorMode
    {
        get
        {
            if (Enum.TryParse<ColorEffectMode>(ColorModeName, true, out var parsed))
                return parsed;
    ...
    public ShadowEffectMode ShadowMode
    {
        get
        {
            if (Enum.TryParse<ShadowEffectMode>(ShadowModeName, true, out var parsed))
                return parsed;
    ...
    public WobbleOrigin WobbleOrigin
    {
        get
        {
            if (Enum.TryParse<WobbleOrigin>(WobbleOriginName, true, out var parsed))
                return parsed;

                ...
                lock (_streamLock)
                {
                    ...
                    try
                    {
                        ...
                        return defaultDevice != -1
                            && _deviceErrorCount < MaxDeviceErrorsBeforeRecovery;
                    }
                    catch
                    {
                        return false;
...
#pragma warning disable CA1031
            try
            {
                ...
                )
                {
                    ...
                    DeviceErrorType errorType = statusFlags.HasFlag(
                        StreamCallbackFlags.OutputUnderflow
                    )
                    ...
                    DeviceError?.Invoke(
                        this,
                        new DeviceErrorEventArgs(errorType, _deviceErrorCount)
                    );
                ...
                catch (Exception ex)
                {
                    DeviceError?.Invoke(
                        ...
                        new DeviceErrorEventArgs(
                            DeviceErrorType.RecoveryFailed,
                            _deviceErrorCount,
                            ex
                        )
                    );

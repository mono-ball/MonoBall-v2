...
namespace MonoBall.Core.Maps
{
    ...
    public class SpriteDefinition
    {
        ...
        public List<SpriteAnimation> Animations { get; set; } = new List<SpriteAnimation>();
    }
    ...
    public class SpriteAnimation
    {
        ...
        public List<int> FrameIndices { get; set; } = new List<int>();

        /// <summary>
        /// The durations for each frame in seconds.
        /// </summary>
        [JsonPropertyName("frameDurations")]
        public List<double> FrameDurations { get; set; } = new List<double>();

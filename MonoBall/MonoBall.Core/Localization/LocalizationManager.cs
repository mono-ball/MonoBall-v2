...
namespace MonoBall.Core.Localization;

/// <summary>
///     Manages localization settings for the game, including retrieving supported cultures and setting the current culture
///     for localization.
/// </summary>
internal class LocalizationManager
{
    ...
    /// <remarks>
    ///     This method iterates through all specific cultures defined in the satellite assemblies and attempts to load the
    ///     corresponding resource set.
    ///     If a resource set is found for a particular culture, that culture is added to the list of supported cultures. The
    ///     invariant culture
    ...
    public static List<CultureInfo> GetSupportedCultures()
    {
        ...
        var resourceManager = new ResourceManager("MonoBall.Core.Localization.Resources", assembly);
    ...
    /// <remarks>
    ///     This method modifies the <see cref="Thread.CurrentThread.CurrentCulture" /> and
    ///     <see cref="Thread.CurrentThread.CurrentUICulture" /> properties,
    ///     which affect how dates, numbers, and other culture-specific values are formatted, as well as how localized

...
This document analyzes the UI Window System design for architecture issues, SOLID/DRY violations, Arch ECS/Event issues,
and .cursorrule compliance.
...
**Location**: `BitmapBackgroundRenderer`, `TileSheetBackgroundRenderer`, `SimpleTextContentRenderer`,
...
- For **tile-based renderers**: Pass base tile size to constructor (unscaled), calculate scaled tile size in Render
